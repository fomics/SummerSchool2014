...
!       IF (.NOT.MPI_ASYNC_PROTECTS_NONBLOCKING) CALL MPI_F_sync_reg(rcv_buf_right)
        ...
        CALL MPI_WIN_POST (grp_left,  MPI_MODE_NOSTORE, win_rcv_buf_left,  ierror)
        CALL MPI_WIN_POST (grp_right, MPI_MODE_NOSTORE, win_rcv_buf_right, ierror)
        CALL MPI_WIN_START(grp_right, 0, win_rcv_buf_left,  ierror)
        CALL MPI_WIN_START(grp_left,  0, win_rcv_buf_right, ierror)
...
!       IF (.NOT.MPI_ASYNC_PROTECTS_NONBLOCKING) CALL MPI_F_sync_reg(rcv_buf_right)
        ...
        CALL MPI_WIN_COMPLETE(win_rcv_buf_left , ierror)
        CALL MPI_WIN_COMPLETE(win_rcv_buf_right, ierror)
        CALL MPI_WIN_WAIT    (win_rcv_buf_left,  ierror)
        CALL MPI_WIN_WAIT    (win_rcv_buf_right, ierror)
