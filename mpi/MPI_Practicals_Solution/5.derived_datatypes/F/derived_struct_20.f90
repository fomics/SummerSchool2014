...
! Create derived datatype. 
  ...
  DO i = 1, size
     ...
     CALL MPI_ISSEND(snd_buf, 1, send_recv_type, right, to_right, MPI_COMM_WORLD, request, ierror)

     CALL MPI_RECV(rcv_buf, 1, send_recv_type, left, to_right, MPI_COMM_WORLD, status, ierror)
