...
! Create derived datatype. 
  ...
  CALL MPI_GET_ADDRESS(buf%i, first_var_address, ierror)
  CALL MPI_GET_ADDRESS(buf%r, second_var_address, ierror)
  ...
  DO i = 1, size
     ...
     CALL MPI_SENDRECV_REPLACE(buf, 1, send_recv_type, right, to_right,  &
                                                       left, to_right,   &
