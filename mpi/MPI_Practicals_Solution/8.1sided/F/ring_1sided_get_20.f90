...
! CREATE THE WINDOW.
  ...
  CALL MPI_WIN_CREATE(snd_buf, rcv_buf_size, disp_unit, MPI_INFO_NULL, MPI_COMM_WORLD, win, ierror)
  target_disp = 0
...
!        access to snd_buf across this dummy call. 
     ...
     CALL MPI_GET(rcv_buf, 1, MPI_INTEGER, left, target_disp, 1, MPI_INTEGER, win, ierror)
