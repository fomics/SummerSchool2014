...
!              halo-communication                 halo-communication
  ...
  CALL MPI_ALLOC_MEM(buf_size, MPI_INFO_NULL, ptr_rcv_buf_left, ierror)
  CALL C_F_POINTER(ptr_rcv_buf_left, rcv_buf_left, (/max_length/))
  CALL MPI_WIN_CREATE(rcv_buf_left,  buf_size, disp_unit, MPI_INFO_NULL, MPI_COMM_WORLD, win_rcv_buf_left,  ierror)
  CALL MPI_ALLOC_MEM(buf_size, MPI_INFO_NULL, ptr_rcv_buf_right, ierror)
  CALL C_F_POINTER(ptr_rcv_buf_right, rcv_buf_right, (/max_length/))
  CALL MPI_WIN_CREATE(rcv_buf_right, buf_size, disp_unit, MPI_INFO_NULL, MPI_COMM_WORLD, win_rcv_buf_right, ierror)
  target_disp = 0
...
!       ...snd_buf_... is used to store the values that were stored in snd_buf_... in the neighbor process
  ...
  CALL MPI_FREE_MEM(rcv_buf_left, ierror)
  CALL MPI_FREE_MEM(rcv_buf_right, ierror)
