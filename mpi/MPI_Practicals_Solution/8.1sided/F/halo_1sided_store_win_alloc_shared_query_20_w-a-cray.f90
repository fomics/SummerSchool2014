...
!              halo-communication                 halo-communication
  ...
  CALL MPI_WIN_ALLOCATE_SHARED(buf_size, disp_unit, info_noncontig, MPI_COMM_WORLD, ptr_rcv_buf_left, win_rcv_buf_left, ierror)
  CALL C_F_POINTER(ptr_rcv_buf_left, rcv_buf_left, (/max_length/))
  CALL MPI_WIN_ALLOCATE_SHARED(buf_size, disp_unit, info_noncontig, MPI_COMM_WORLD, ptr_rcv_buf_right, win_rcv_buf_right, ierror)
...
! ... shared memory access to the rcv_buf_left, of the RIGHT neighbor process
  CALL MPI_WIN_SHARED_QUERY(win_rcv_buf_left, right, buf_size, disp_unit, ptr_rcv_buf_left_neighbor, ierror)
...
! ... shared memory access to the rcv_buf_right, of the LEFT neighbor process
  CALL MPI_WIN_SHARED_QUERY(win_rcv_buf_right, left, buf_size, disp_unit, ptr_rcv_buf_right_neighbor, ierror)
...
!       ... is substited by:
        ...
        CALL MPI_GET_ADDRESS(rcv_buf_left_neighbor,  iadummy, ierror)
        CALL MPI_GET_ADDRESS(rcv_buf_right_neighbor, iadummy, ierror)
!       ... or with MPI-3.0 and later:
