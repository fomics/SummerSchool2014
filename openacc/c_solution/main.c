...
int main(int argc, char* argv[])
{
    ...
    #pragma acc data copy(x_old[0:nx*ny], x_new[0:nx*ny], deltax[0:nx*ny], Ap[0:nx*ny], p[0:nx*ny], r[0:nx*ny], b[0:nx*ny], v[0:nx*ny], Fx[0:nx*ny], Fxold[0:nx*ny], xold[0:nx*ny], bndN[0:nx], bndE[0:ny], bndS[0:nx], bndW[0:ny], options)
    {
		// start timer
