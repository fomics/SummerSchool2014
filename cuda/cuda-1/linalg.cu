...
{
	// TODO: Copy X and Y arrays onto GPU

	// TODO: transfer axpy loop into kernel body
	// TODO: launch axpy as a kernel
	int i;
    for (i = 0; i < N; i++)
        y[i] += alpha * x[i];
       
    // TODO: Wait for axpy kernel to finish
    // TODO: Copy back y array to host from GPU.
